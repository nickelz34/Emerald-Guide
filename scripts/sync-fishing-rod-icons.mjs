/**
 * Export Old / Good / Super Rod bag icons and merge into itemIconsGenerated.ts.
 * Fetches from pret/pokeemerald when local .calib/pokeemerald assets are absent.
 *
 * Usage: node scripts/sync-fishing-rod-icons.mjs
 */
...
const FISHING_ROD_ITEMS = [
  { name: "Old Rod", const: "ITEM_OLD_ROD", file: "old_rod.png" },
  { name: "Good Rod", const: "ITEM_GOOD_ROD", file: "good_rod.png" },
  { name: "Super Rod", const: "ITEM_SUPER_ROD", file: "super_rod.png" },
];
...
const added = {};
for (const item of FISHING_ROD_ITEMS) {
...
console.log(`Updated ${OUT_TS} (+${Object.keys(added).length} fishing rod icons)`);
