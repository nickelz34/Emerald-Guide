// AUTO-GENERATED by scripts/gen-map-landmarks.mjs — do not edit by hand.
// Towns = composite bbox centers; gyms/landmarks = outdoor entrance warps.
import type { MapPoint } from "./mapPoints";

export const LANDMARK_PINS_GENERATED: MapPoint[] = [
