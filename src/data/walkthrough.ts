    ...
    steps: [
      {
        ...
        story: [
          ...
          "Before the Gym, talk to the fisherman on the south shore — he gives you the Old Rod for basic fishing on any water tile. Dewford also runs on gossip: chat with the townsfolk and you'll pick up the island's obsession with what's \"hip and happening\" — a running errand that has you carrying trendy news between towns, netting a Silk Scarf from the local trend-setter when you impress him.",
        ],
        details: [
          ...
          "Chat with the townsfolk to start the 'hip and happening' trend spread.",
        ],
        secrets: [
    ...
    steps: [
      {
        ...
        story: [
          ...
          "Return to Devon Corp in Rustboro before you sail on — Mr. Stone gives you the Exp. Share on the 3F once he knows the Letter was delivered.",
        ],
        details: [
    ...
    steps: [
      {
        ...
        details: [
          ...
          "After returning Devon Goods, a Devon worker in the market gives you the Itemfinder for hidden items.",
    ...
    steps: [
      {
        ...
        story: [
          ...
          "A local in the southeast hands over HM06 Rock Smash, letting you shatter the cracked boulders blocking so many caves. The woman in the house next to the Game Corner gives you the Coin Case — you'll need it to play the slots and buy TMs like TM32 Double Team. And right on cue, Wally returns — healthier and eager — with his father, and challenges you to a spirited battle to show off how far his Ralts has come.",
        ],
        details: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        story: [
          "At the cavern's heart, Aqua Admin Matt makes a last stand before Archie himself takes the field. Beat them both and you arrive just as Archie uses the Red Orb to awaken Kyogre — only for the sea Pokémon to ignore him entirely and surge away, unleashing endless rain across Hoenn.",
    ...
    steps: [
      {
        ...
        story: [
          ...
          "Steven meets you at the entrance and escorts you into the Cave of Origin at the city's heart, hoping the legendaries can be calmed from within. They're not — the orbs' power is beyond anything you can suppress alone, and Wallace will direct you to Sky Pillar from inside the cave.",
        ],
        details: [
