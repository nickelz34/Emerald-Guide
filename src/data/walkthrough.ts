    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          "He gives you the PokéNav (Map, Condition, Match Call) and asks you to deliver a Letter to Steven in Dewford.",
          "Match Call auto-registers trainers you defeat; rematches unlock after becoming Champion.",
    ...
    steps: [
      {
        ...
        secrets: [
          "Spreading a new \"hip and happening\" phrase from another town to Dewford's trend boy earns a Silk Scarf.",
    ...
    steps: [
      ...
      },
      {
        ...
        story: [
          ...
          "With Shelly beaten, the grateful scientists thank you with Castform, a quirky Normal-type that shifts form with the weather. Check the bed in the back room for HM02 Fly — the rival waiting outside does not give it.",
        ],
        details: [
          "Battle Aqua Grunts through the building.",
          "Defeat Aqua Admin Shelly on the top floor.",
          "The scientists give you Castform; pick up HM02 Fly from the bed in the back room.",
        ],
      ...
      },
      {
        ...
        story: [
          "Just north of the institute, your rival is waiting for another showdown — and this time they've brought a full team that will genuinely test your coverage. Win and they'll cheer you on toward Fortree before dashing off.",
          "You already picked up HM02 Fly inside the institute. Fly is a game-changer for backtracking, but note that you can't use it in the field until you earn the Feather Badge from Fortree's Gym. Head there next — though a colour-shifting roadblock waits in town first.",
        ],
        details: [
          "Just past the institute, Brendan/May challenges you with a full team.",
          "Defeat them — Fly was already on the bed inside the Weather Institute.",
