  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        secrets: [
          "After the credits, you return home to find a National Dex upgrade waiting — the post-game opens up roaming legendaries, the Battle Frontier, and every remaining legendary hunt.",
        ],
