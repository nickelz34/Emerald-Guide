...
export const AREA_DATA: Record<string, AreaExtras> = {
  ...
  "abandoned-ship": {
    secrets: [
      ...
      "TM13 Ice Beam and Harbor Mail in the upper cabins — Dive unlocks the flooded lower decks.",
    ],
    encounters: [],
  },
  "shoal-cave": {
...
export const STEP_AREA_MAP: Record<string, string[]> = {
  ...
  "postgame-hoenn-6": ["route-110"],
  "postgame-hoenn-8": ["route-103"],
  "postgame-hoenn-9": ["lilycove"],
  "battle-frontier-5": ["battle-frontier"],
  "battle-frontier-6": ["battle-frontier"],
  "contests-postgame-blend": ["lilycove"],
