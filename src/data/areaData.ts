...
export const STEP_AREA_MAP: Record<string, string[]> = {
  start: ["route-101", "route-102", "route-103"],
  petalburg: ["petalburg-woods", "route-104"],
  "stone-badge": ["route-116", "rusturf-tunnel", "granite-cave"],
  "knuckle-badge": ["dewford", "granite-cave"],
  "slateport-museum": ["slateport", "route-110"],
  "dynamo-badge": ["mauville", "route-110"],
  chimney: ["fiery-path", "mt-chimney", "route-113"],
  "heat-badge": ["fallarbor", "fiery-path", "route-113"],
  norman: ["route-104"],
  "feather-badge": ["route-120"],
  "weather-institute": ["route-119"],
  "mt-pyre": ["mt-pyre"],
  "mind-badge": ["mossdeep"],
  "seafloor-cavern": ["marine-cave"],
  "sootopolis-rayquaza": ["sootopolis", "sky-pillar", "pacifidlog"],
  "rain-badge": ["sootopolis"],
  "victory-road": ["victory-road", "ever-grande"],
  "trick-1": ["route-110"],
  "trick-2": ["route-110"],
  "trick-3": ["route-110"],
  "trick-4": ["route-110"],
