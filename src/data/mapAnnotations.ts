...
export const MARKER_LEGEND: { type: MarkerType; label: string; color: string; symbol: string }[] = [
  ...
  { type: "wild", label: "Wild encounters (terrain)", color: "#48bb78", symbol: "🌿" },
];
...
export const MAP_ANNOTATIONS: Record<string, MapAnnotation> = {
  ...
  "route-101": {
    ...
    markers: [
      ...
      },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Poochyena, Wurmple, Zigzagoon.",
        x: 17.5,
        y: 22.5,
      },
  ...
  "route-102": {
    ...
    markers: [
      ...
      { id: "r102-oldale", type: "poi", label: "To Oldale", x: 99, y: 52.5 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Ralts at 4%.",
        x: 39,
        y: 52.5,
      },
      {
        id: "r102-wally",
        type: "poi",
        label: "Wally catches Ralts",
        detail: "Story event in the northeast grass — same route encounter table (Ralts 4%).",
        x: 77,
        y: 22.5,
      },
  ...
  "route-103": {
    ...
    markers: [
      { id: "r103-sign", type: "poi", label: "Route sign", x: 14.4, y: 43.2 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route.",
        x: 10.6,
        y: 20.5,
      },
      ...
      { id: "r103-cave", type: "building", label: "Cave entrance", detail: "North cliff cave on the east side.", x: 56.9, y: 29.5 },
      {
        ...
        type: "wild",
        label: "Surf / fish",
        detail: "Same water encounters on any water tile — Wingull, Magikarp.",
        x: 45.6,
        y: 29.5,
      },
  ...
  "petalburg-woods": {
    ...
    markers: [
      ...
      { id: "pw-item2", type: "item", label: "Potion", detail: "Hidden item — east side.", x: 82.3, y: 80.7 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass here — Shroomish 10%.",
        x: 40.6,
        y: 42,
      },
    ],
  ...
  "route-104": {
    ...
    markers: [
      ...
      { id: "r104-berry", type: "npc", label: "Berry florist", detail: "White Herb florist east of the flower shop.", x: 21.3, y: 24.4 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Taillow, Wingull, and more.",
        x: 73.8,
        y: 10.6,
      },
  ...
  "route-116": {
    ...
    markers: [
      ...
      { id: "r116-hp", type: "item", label: "HP Up", detail: "Item ball — east end past the tunnel.", x: 80.5, y: 42.5 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Abra 4%, Nincada, Whismur.",
        x: 12.5,
        y: 37.5,
      },
    ],
  ...
  "rusturf-tunnel": {
    ...
    markers: [
      ...
      { id: "rt-cave-e", type: "building", label: "Tunnel entrance (east)", x: 81.9, y: 68.8 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Exterior approach grass — same Route 116 table in any tall grass tile (not the cave interior).",
        x: 51.4,
        y: 85.4,
      },
    ],
  ...
  "route-110": {
    ...
    markers: [
      ...
      { id: "r110-rival", type: "trainer", label: "Rival battle", detail: "On the main road near the east grass strip.", x: 86.3, y: 54.5 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Oddish, Gulpin, Electrike.",
        x: 8.8,
        y: 39.5,
      },
  ...
  "route-117": {
    ...
    markers: [
      ...
      { id: "r117-daycare", type: "building", label: "Pokémon Day Care", x: 85.8, y: 27.5 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Marill, Oddish, and more.",
        x: 42.5,
        y: 62.5,
      },
    ],
  ...
  "route-118": {
    ...
    markers: [
      ...
      { id: "r118-wally", type: "poi", label: "Steven cutscene", detail: "After Norman — Steven on the east path.", x: 55.6, y: 37.5 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route (Surf to reach eastern patches).",
        x: 66.9,
        y: 62.5,
      },
    ],
  ...
  "mt-chimney": {
    ...
    markers: [
      ...
      { id: "mc-meteor", type: "item", label: "Meteorite", detail: "Path down from summit.", x: 51.3, y: 88.3 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on the slopes — Numel, Spoink.",
        x: 41.3,
        y: 39.4,
      },
    ],
  ...
  "route-113": {
    ...
    markers: [
      ...
      { id: "r113-glass", type: "npc", label: "Glass Workshop", detail: "Free Soothe Bell.", x: 33.5, y: 27.5 },
      {
        ...
        type: "wild",
        label: "Ash grass",
        detail: "Same encounters on any ash-grass tile — Spinda, Sandshrew, rare Skarmory.",
        x: 45.5,
        y: 32.5,
      },
  ...
  "route-119": {
    ...
    markers: [
      ...
      { id: "r119-kecleon", type: "wild", label: "Kecleon", detail: "Invisible encounter — north section (fixed location, not the grass table).", x: 78.8, y: 4.6 },
      {
        ...
        type: "wild",
        label: "Tall grass",
        detail: "Same encounters in any tall grass on this route — Tropius 5%.",
        x: 31.3,
        y: 88.2,
      },
      {
        ...
        detail:
          "Only six numbered fishing-spot IDs on Route 119 can yield Feebas (any rod). Use the Feebas calculator on Ch. 33 event 4 of 4 (Hunt Feebas on the river). IDs reshuffle when Dewford’s trendy phrase changes; Surf never finds Feebas.",
        x: 48,
        y: 55,
      },
  ...
  "route-120": {
    ...
    markers: [
      ...
      { id: "r120-kecleon", type: "wild", label: "Kecleon", detail: "Invisible — blocks the bridge until scoped (fixed location, not the grass table).", x: 31.3, y: 16.5 },
      {
        id: "r120-grass",
        type: "wild",
        label: "Tall grass",
  ...
  sootopolis: {
    ...
    markers: [
      ...
      { id: "soo-rod", type: "wild", label: "Central lake", detail: "Same surf/fish encounters on any water tile in the central lake.", x: 52.5, y: 67.5 },
  ...
  pacifidlog: {
    ...
    markers: [
      ...
      { id: "pac-surf", type: "wild", label: "Surf", detail: "Same water encounters on any surf tile — Tentacool, Wingull.", x: 42.5, y: 51.3 },
    ],
  },
  "sky-pillar": {
    title: "Sky Pillar",
  ...
  "victory-road": {
    ...
    markers: [
      ...
      { id: "vr-exterior", type: "wild", label: "Tall grass", detail: "Same encounters in any tall grass outside Victory Road.", x: 55, y: 38 },
    ],
  },
  "sealed-chamber": {
  ...
  "route-105": {
    ...
    markers: [
      ...
      { id: "r105-surf", type: "wild", label: "Surf / rods", detail: "Same water encounters on any water tile on this route.", x: 48.8, y: 50.6 },
  ...
  "route-111": {
    ...
    markers: [
      ...
      { id: "r111-grass", type: "wild", label: "Desert grass", detail: "Same encounters in any tall grass on this route — Sandshrew, Spinda, Skarmory.", x: 56.3, y: 55.4 },
