...
export const AREA_MAPS: AreaMap[] = [
  ...
  {
    // Hand-added cutscene map — rival at north shore. Tiles-only; May is overlay.
    id: "route103",
    mapId: "MAP_ROUTE103",
    name: "Route 103",
    group: "Route 103",
    floor: "",
    image: "maps/areas/route103.png",
    width: 1280,
    height: 352,
    markers: [
      {
        id: "r103-exit-south",
        name: "Oldale Town (South)",
        category: "entrance",
        x: 13.125,
        y: 97.5,
        desc: "South exit — back to Oldale Town.",
      },
    ],
  },
  {
    // Hand-added cutscene map — trainers / rare Ralts. Tiles-only base.
    id: "route102",
    mapId: "MAP_ROUTE102",
    name: "Route 102",
    group: "Route 102",
    floor: "",
    image: "maps/areas/route102.png",
    width: 800,
    height: 320,
    markers: [
      {
        id: "r102-exit-east",
        name: "Oldale Town (East)",
        category: "entrance",
        x: 97.5,
        y: 52.5,
        desc: "East exit — back to Oldale Town.",
      },
      {
        id: "r102-exit-west",
        name: "Petalburg City (West)",
        category: "entrance",
        x: 2.5,
        y: 52.5,
        desc: "West exit — into Petalburg City.",
      },
    ],
  },
  {
    // Same Route 102 tiles; Wally + Zigzagoon overlays for the catching tutorial.
    id: "route102-wally",
    mapId: "MAP_ROUTE102",
    name: "Route 102",
    group: "Route 102",
    floor: "Wally's catching tutorial",
    image: "maps/areas/route102-wally.png",
    width: 800,
    height: 320,
    markers: [],
  },
  {
    // Hand-added — Mom / Running Shoes outside the player house.
    id: "littleroottown",
    mapId: "MAP_LITTLEROOT_TOWN",
    name: "Littleroot Town",
    group: "Littleroot Town",
    floor: "",
    image: "maps/areas/littleroottown.png",
    width: 320,
    height: 320,
    markers: [],
  },
  {
    // Hand-added Petalburg exterior for stock-up / arrival steps.
    id: "petalburgcity",
    mapId: "MAP_PETALBURG_CITY",
    name: "Petalburg City",
    group: "Petalburg City",
    floor: "",
    image: "maps/areas/petalburgcity.png",
    width: 480,
    height: 480,
    markers: [
      {
        id: "petalburg-exit-east",
        name: "Route 102 (East)",
        category: "entrance",
        x: 97.5,
        y: 52.5,
        desc: "East exit — Route 102 toward Oldale.",
      },
      {
        id: "petalburg-exit-west",
        name: "Route 104 (West)",
        category: "entrance",
        x: 2.5,
        y: 52.5,
        desc: "West exit — Route 104 toward Petalburg Woods.",
      },
    ],
  },
  {
    id: "petalburgcity-mart",
    mapId: "MAP_PETALBURG_CITY_MART",
    name: "Petalburg City Poké Mart",
    group: "Petalburg City",
    floor: "Poké Mart",
    image: "maps/areas/petalburgcity-mart.png",
    width: 176,
    height: 128,
    markers: [],
  },
  {
    id: "petalburgcity-pokemoncenter-1f",
    mapId: "MAP_PETALBURG_CITY_POKEMON_CENTER_1F",
    name: "Petalburg City Pokémon Center",
    group: "Petalburg City",
    floor: "Pokémon Center 1F",
    image: "maps/areas/petalburgcity-pokemoncenter-1f.png",
    width: 224,
    height: 144,
    markers: [],
  },
  {
    // Early Norman meet — cropped gym entrance (Wally + Norman). Full gym stays for the badge fight.
