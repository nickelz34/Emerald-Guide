  ...
  steps: [
    {
      ...
      tips: [
        ...
        "In doubles, check both foes before locking a single-target move; Surf is safe spread, Earthquake is not.",
      ],
      secrets: [
