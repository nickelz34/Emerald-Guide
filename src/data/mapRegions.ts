...
export const MAP_REGIONS: MapRegion[] = [
  ...
  { id: "lilycove", label: "Lilycove", x: 72, y: 44, stepIds: ["lilycove-1", "contests-lilycove-1", "contests-lilycove-2", "contests-lilycove-4", "contests-lilycove-5", "contests-postgame-2", "mt-pyre-1", "postgame-events-1", "postgame-events-2", "postgame-events-3", "postgame-events-4", "postgame-events-5"] },
  ...
  { id: "frontier", label: "Battle Frontier", x: 77, y: 69, stepIds: ["battle-frontier-1", "battle-frontier-2", "battle-frontier-3", "battle-frontier-4", "battle-frontier"] },
