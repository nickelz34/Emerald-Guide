...
export const MAP_REGIONS: MapRegion[] = [
  ...
  { id: "lilycove", label: "Lilycove", x: 72, y: 44, stepIds: ["lilycove-1", "contests-lilycove-1", "contests-lilycove-2", "contests-lilycove-4", "contests-lilycove-5", "contests-postgame-2", "mt-pyre-1"] },
