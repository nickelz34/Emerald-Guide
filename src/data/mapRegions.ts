...
export const MAP_REGIONS: MapRegion[] = [
  { id: "littleroot", label: "Littleroot", x: 11.5, y: 83, stepIds: ["littleroot-1", "route-101-1", "secret-base"] },
  ...
  { id: "slateport", label: "Slateport", x: 39, y: 69, stepIds: ["slateport-1"] },
  { id: "mauville", label: "Mauville", x: 43, y: 53, stepIds: ["mauville-1", "route-117-1", "berry-master"] },
  {
    id: "route110",
    label: "Route 110",
    x: 37,
  ...
  { id: "mt-chimney", label: "Mt. Chimney", x: 51, y: 31, stepIds: ["mt-chimney-1", "route-111-1", "route-112-1", "magma-hideout-1", "groudon"] },
  ...
  { id: "lilycove", label: "Lilycove", x: 72, y: 44, stepIds: ["lilycove-1", "mt-pyre-1", "latios-latias"] },
  { id: "mossdeep", label: "Mossdeep", x: 81, y: 41, stepIds: ["mossdeep-1", "seafloor-cavern-1", "master-ball"] },
  { id: "sootopolis", label: "Sootopolis", x: 71, y: 29, stepIds: ["sootopolis-1", "sootopolis-gym-1", "kyogre"] },
  { id: "sky-pillar", label: "Sky Pillar", x: 89, y: 17, stepIds: ["sky-pillar-1", "rayquaza-catch"] },
